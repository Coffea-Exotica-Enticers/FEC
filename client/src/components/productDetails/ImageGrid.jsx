  ...
  return (
    <div className="Top_left-pane">
      <ul className="product-images-grid">
        <button type="button" className="product-left-button-image" onClick={(e) => goToPrevious(e)}>
        ...
        <button type="button" className="product-right-button-image" onClick={(e) => goToNext(e)}>
          <svg height="12px" width="12px" fill="#000" viewBox="0 0 185.4 300">
